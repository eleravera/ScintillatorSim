...
void LabInfo::dump() {
    ...
    fprintf(fileInfo, "PVC dimensions: %4.2f mm, %4.2f mm, %4.2f mm\n",  PVCSize[0],  PVCSize[1], PVCSize[2]);

    fprintf(fileInfo, "Scintillator position: %2.2f mm, %2.2f mm, %2.2f mm\n",  scintPos[0],  scintPos[1], scintPos[2]);

    fprintf(fileInfo, "PVC position: %2.2f mm, %2.2f mm, %2.2f mm\n",  PVCPos[0],  PVCPos[1], PVCPos[2]);
